"""
Django settings for memerator project.
...
WSGI_APPLICATION = 'memerator.wsgi.application'
...
MEDIA_ROOT = os.environ.get('MEDIA_ROOT', os.path.join(BASE_DIR, 'tmp'))